...
sync_env () {
  echo "Syncing ${@:2}"
  pnpm exec wrangler kv:key put org-settings-$1 '{"orgExists": true, "staticFiles": {"microfrontendProxy": {"environments": {"__main__": {"customHost": "https://react.microfrontends.app/", "useBaseplateHosting": true}}}}}' --binding MAIN_KV ${@:2}
